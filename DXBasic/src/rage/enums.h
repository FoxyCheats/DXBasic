...
inline std::map<const char*, int> sessionTypes = {
	{ "Join a public session", 0 },
	{ "Start a solo public session", 1 },
	{ "Start a closed crew session", 2 },
	{ "Start a solo crew session", 3 },
	{ "Start a closed friend session", 6 },
	{ "Find friends in session", 9 },
	{ "Start a solo session", 10 },
	{ "Start a invite-only session", 11 },
	{ "Find crew memebers in session", 12 },
	{ "Leave GTA Online", -1 },
};
